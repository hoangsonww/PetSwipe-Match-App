...
- **Observable**: Prometheus + Grafana + Datadog + CloudWatch for full-stack monitoring
...
C4Context
    ...
    System_Ext(monitoring, "Monitoring", "Prometheus/Grafana/Datadog")
...
- **3D Rendering**: React Three Fiber + Three.js + Framer Motion + WebGL
- **UI Library**: React 18
...
- and more pages/components in the app...
...
flowchart TB
    ...
    subgraph Collection["📊 Collection Layer"]
        ...
        DDAgent["Datadog Agent<br/>- APM Traces (8126)<br/>- DogStatsD (8125)<br/>- Log Collection"]
        DDClusterAgent["Datadog Cluster Agent<br/>- K8s Events<br/>- External Metrics<br/>- Cluster Checks"]
    end

    subgraph Storage["💾 Metrics Storage"]
        Prometheus["Prometheus<br/>- Metrics Storage<br/>- PromQL Engine<br/>- Retention: 15d"]
        DatadogCloud["Datadog Platform<br/>- APM & Traces<br/>- Log Management<br/>- Infrastructure Metrics<br/>- SLO Tracking"]
    end
    ...
    subgraph Visualization["📈 Visualization"]
        ...
        DDDashboard["Datadog Dashboards<br/>- Golden Signals<br/>- Service Map<br/>- Business Metrics"]
    end

    subgraph Logging["📝 Logging"]
        AppLogs["Application Logs<br/>(Morgan)"]
        CloudWatchLogs["CloudWatch Logs<br/>- Log Groups<br/>- Log Streams"]
        LogInsights["CloudWatch Insights"]
        DDLogs["Datadog Log<br/>Management<br/>- Trace Correlation<br/>- Log Pipelines"]
    end

    subgraph Tracing["🔍 Distributed Tracing"]
        XRay["AWS X-Ray<br/>- Request Tracing<br/>- Service Map"]
        DDTrace["Datadog APM<br/>- Distributed Traces<br/>- Service Map<br/>- Continuous Profiling"]
    end

    subgraph Alerting["🚨 Alerting"]
        PrometheusAlerts["Prometheus Alertmanager"]
        DDMonitors["Datadog Monitors<br/>- 11 Production Monitors<br/>- Anomaly Detection<br/>- Composite Alerts"]
        SNS["AWS SNS<br/>- Email · Slack"]
        PagerDuty["PagerDuty<br/>- Incident Management"]
    end

    subgraph SLOs["🎯 SLO Tracking"]
        DDSLOs["Datadog SLOs<br/>- 99.9% Availability<br/>- P99 Latency"]
        CWSLOs["CloudWatch SLIs<br/>- Error Budget<br/>- Availability"]
    end
    ...
    DDClusterAgent --> DatadogCloud
    Prometheus --> Grafana
    DatadogCloud --> DDDashboard
    Backend --> CloudWatch
    Frontend --> CloudWatch
    ...
    CloudWatch --> SNS
    DatadogCloud --> DDMonitors
    DDMonitors --> PagerDuty
    SNS --> PagerDuty
...
flowchart TB
    ...
    subgraph Notifications["📢 Notifications"]
        ...
        DDMonitors["Datadog Monitors<br/>- APM error rate<br/>- Latency anomalies<br/>- Log error spikes"]
        Email["Email Alerts<br/>- DevOps team"]
        Slack["Slack Integration<br/>- #deployments channel"]
        PagerDuty["PagerDuty<br/>- Incident routing"]
    end
