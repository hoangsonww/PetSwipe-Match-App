...
const SignupPage: NextPage = () => {
  ...
  // Mascot eyes tracking (window-level like on login)
            ...
            <div className="order-1 md:order-1 mb-8 md:mb-0">
              <div className="mb-6">
                ...
                <p className="mt-1 text-[#234851]/70 dark:text-[#B6EBE9]/80">
                  Create an account to start swiping and finding your perfect
                  pet match! 🐰
                </p>
              </div>
              ...
              <p className="mt-6 text-sm text-neutral-600 dark:text-neutral-400">
                This adorable mascot is here to keep you company while you sign
                up. Enjoy the cuteness overload!
              </p>
            </div>
