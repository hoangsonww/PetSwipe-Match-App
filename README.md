...
![React](https://img.shields.io/badge/React-20232A?style=flat-square&logo=react&logoColor=61DAFB) ![Radix UI](https://img.shields.io/badge/Radix_UI-161618?style=flat-square&logo=radixui&logoColor=white) ![SWR](https://img.shields.io/badge/SWR-000000?style=flat-square&logoColor=white&logo=swr) ![Recharts](https://img.shields.io/badge/Recharts-FF6384?style=flat-square&logoColor=white&logo=recharts) ![Axios](https://img.shields.io/badge/Axios-5A29E4?style=flat-square&logo=axios&logoColor=white) ![React Hook Form](https://img.shields.io/badge/React_Hook_Form-EC5990?style=flat-square&logo=reacthookform&logoColor=white) ![Zod](https://img.shields.io/badge/Zod-3E67B1?style=flat-square&logoColor=white&logo=Zod) ![Lucide](https://img.shields.io/badge/Lucide-18181B?style=flat-square&logoColor=white&logo=lucide) ![date-fns](https://img.shields.io/badge/date--fns-770C56?style=flat-square&logoColor=white&logo=datefns) ![React Markdown](https://img.shields.io/badge/React_Markdown-000000?style=flat-square&logo=markdown&logoColor=white) ![KaTeX](https://img.shields.io/badge/KaTeX-008080?style=flat-square&logoColor=white&logo=katex) ![next-themes](https://img.shields.io/badge/next--themes-000000?style=flat-square&logo=nextdotjs&logoColor=white) ![Embla Carousel](https://img.shields.io/badge/Embla_Carousel-1F1F1F?style=flat-square&logoColor=white&logo=emblacarousel) ![Sonner](https://img.shields.io/badge/Sonner-FF6B6B?style=flat-square&logoColor=white&logo=sonner) ![Vaul](https://img.shields.io/badge/Vaul-111111?style=flat-square&logoColor=white&logo=vaul) ![Vercel Analytics](https://img.shields.io/badge/Vercel_Analytics-000000?style=flat-square&logo=vercel&logoColor=white)
![Firebase](https://img.shields.io/badge/Firebase-FFCA28?style=flat-square&logo=firebase&logoColor=black) ![bcryptjs](https://img.shields.io/badge/bcryptjs-4C8BF5?style=flat-square&logoColor=white&logo=bcryptjs) ![cookie-parser](https://img.shields.io/badge/cookie--parser-D2691E?style=flat-square&logo=cookies&logoColor=white) ![CORS](https://img.shields.io/badge/CORS-005571?style=flat-square&logoColor=white&logo=cors) ![Morgan](https://img.shields.io/badge/Morgan-4B5563?style=flat-square&logoColor=white&logo=morgan) ![Multer](https://img.shields.io/badge/Multer-FFB020?style=flat-square&logoColor=black&logo=multer) ![Sharp](https://img.shields.io/badge/Sharp-99CC00?style=flat-square&logoColor=black&logo=sharp) ![UUID](https://img.shields.io/badge/UUID-3B82F6?style=flat-square&logoColor=white&logo=uuid) ![CSV](https://img.shields.io/badge/CSV-217346?style=flat-square&logoColor=white&logo=csv) ![serverless-http](https://img.shields.io/badge/serverless--http-FD5750?style=flat-square&logo=serverless&logoColor=white) ![Kubernetes](https://img.shields.io/badge/Kubernetes-326CE5?style=flat-square&logo=kubernetes&logoColor=white) ![NGINX](https://img.shields.io/badge/NGINX-009639?style=flat-square&logo=nginx&logoColor=white) ![Jenkins](https://img.shields.io/badge/Jenkins-D24939?style=flat-square&logo=jenkins&logoColor=white)
![Trivy](https://img.shields.io/badge/Trivy-1904DA?style=flat-square&logoColor=white&logo=trivy) ![tfsec](https://img.shields.io/badge/tfsec-3D5AFE?style=flat-square&logo=tfsec&logoColor=white) ![Checkov](https://img.shields.io/badge/Checkov-FCC624?style=flat-square&logo=checkov&logoColor=black) ![Infracost](https://img.shields.io/badge/Infracost-DB44B8?style=flat-square&logo=infracost&logoColor=white) ![OpenAPI](https://img.shields.io/badge/OpenAPI-6BA539?style=flat-square&logo=openapiinitiative&logoColor=white) ![GitHub Container Registry](https://img.shields.io/badge/GitHub_Container_Registry-181717?style=flat-square&logo=github&logoColor=white)
...
- **Admin Tools**:
  ...
  - and more!
- **Feature-Rich UI**: Built with **Tailwind CSS** and **shadcn/ui**
  - Fully responsive design for mobile and desktop
  - 3D animations & components powered by **Framer Motion** and **React Three Fiber** + **Three.js** + **WebGL**
  ...
  - Dedicated adoption planner and preference insights pages with more screen real estate for charts, comparison tables, and detailed pet info instead of shoehorning them into the swipe page
...
PetSwipe includes a comprehensive, multi-layer observability stack covering metrics, logs, traces, and SLO tracking.
...
flowchart LR
    ...
    subgraph Agents["Collection"]
        DD["Datadog Agent"]
        Prom["Prometheus"]
    end

    subgraph Platforms["Observability Platforms"]
        DatadogP["Datadog<br/>APM · Logs · Infra · SLOs"]
        Grafana["Grafana Dashboards"]
        CW["AWS CloudWatch"]
    end

    subgraph Alerting["Alerting"]
        Monitors["Datadog Monitors"]
...
|----------|----------|--------|
| **Datadog** | APM traces, logs, infrastructure, synthetics, SLOs | [app.datadoghq.com](https://app.datadoghq.com) |
| **Prometheus + Grafana** | Application and system metrics | `localhost:9090` / `localhost:3001` |
| **AWS CloudWatch** | ECS, RDS, ALB, custom metrics, alarms | AWS Console |

### Quick Start

```bash
# Start with Prometheus + Grafana (default)
docker compose up -d

# Add Datadog (requires DD_API_KEY)
...
- **APM**: Request traces, service maps, error tracking, latency percentiles (Datadog)
- **Logs**: Centralized log collection with trace correlation (Datadog + CloudWatch)
- **Metrics**: Golden signals, business metrics (swipes/matches), infrastructure (all platforms)
- **SLOs**: 99.9% availability, P99 latency targets (Datadog + CloudWatch)
- **Synthetics**: Automated health endpoint testing every 5 minutes (Datadog)
- **Alerting**: 11 Datadog monitors + CloudWatch alarms → PagerDuty integration

For detailed configuration, see [MONITORING.md](MONITORING.md).
...
© 2025-2026 **[Son Nguyen](https://sonnguyenhoang.com)**. I hope this code is useful for you and your projects. Feel free to use it, modify it, and share it with others.
